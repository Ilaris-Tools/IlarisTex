...
Nach dem Kasten steht auch ein Satz, damit man mal sieht wie doll sich das Pergament vom Text drumherum abhebt. Kästen über die volle Breite können einfach außerhalb des Spaltenlayouts erstellt werden. Im Kapitel Handouts gibt es auch DinA4 Kästen an. Es können auch grauere Kästen verwendet werden, die zwar mehr aus einem \anf{Fehler} entstanden sind, aber vielleicht sind sie ja mal von Nutzen.
